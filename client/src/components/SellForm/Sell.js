...
function Sell() {
    ...
    const [sellItem,setsellItem] = useState(sellItemInitialValues);
                        ...
                        <div className="shadow sm:rounded-md sm:overflow-hidden">
                            <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div>
                                    ...
                                    <input value={sellItem.email} onChange={(e) => onInputChange(e)} type="email" name='email' id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="name@gmail.com"/>
                                </div> 
